...
These Rust/Leptos components are an Onyx implementation visually informed by T3
...
The implementation uses Lucide icons through the Rust `icondata` crate and
Onyx/OpenCode theme tokens. T3 Code's full MIT notice remains required in the
