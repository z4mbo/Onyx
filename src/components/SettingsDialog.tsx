          ...
          <div class="zai-settings-content">
            ...
            <Show when={page() === "account"}>
              <div class="zai-settings-page">
                ...
                <section class="zai-settings-card">
                  <Show when={account().configured} fallback={<div class="zai-setting-row"><div><strong>Desktop sign-in required</strong><span>Account sign-in is available in the packaged Onyx desktop app.</span></div><span class="zai-setting-value">Local only</span></div>}>
